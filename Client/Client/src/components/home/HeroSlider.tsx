...
// Use pre-generated optimized images from `public/optimized` for production
const founderPhoto = '/optimized/slider-residential-1200.webp';
const buildingPhoto = '/optimized/slider-land-1200.webp';
        ...
        >
          {/* Background Image */}
            ...
            {typeof slide.image === 'string' ? (
              <picture>
                <source type="image/webp" srcSet={buildSrcSet(slide.image as string).webpSet} sizes="100vw" />
                <ImageWithFallback
                  src={replaceOrAddParam(slide.image as string, 'w', index === 0 ? '1920' : '1200')}
              ...
              <ImageWithFallback src={slide.image as any} alt={slide.type === 'founder' ? slide.name : slide.title} className="w-full h-full object-cover" priority={index === 0} />
            )}
